                  ...
                  <form action="" method="post" enctype="multipart/form-data">
                    ...
                    <input v-model="formData.titre" type="text" class="form-control" id="titre">
                       ...
                       <div class="form-group">
                            ...
                            <span>
                                <!-- <input type="hidden" :value="formData.photo"> -->
                                <img  :src="formData.photo"  width="90px;" height="80px" alt="">
                            </span>
                            <br> <br>
                             <span style="color:red; font-style:italic;"
                            ...
                            <input  type="file" class="form-control" id="avatar" name="avatar" @change="OnchangeFichierPDFAccueil"
...
created(){
    ...
    this.getAccueil(),
    this.formData = this.gettersAccueil.find(tem=>tem.id == this.$route.params.id)
},
  validations:{
        formData:{
    ...
    methods:{
        ...
        "AjouterconfigEntete", "getconfigEntete","AjouterAccueil","SupprimerAccueil","getAccueil","ModifierAccueil"]),
         ...mapActions("student",["get_all_student","AjouterEleve", "ModifierEleve","SupprimerEleve","ImporterEleve"]),

    
  OnchangeFichierPDFAccueil(e) {
    ...
    createImage(file){
       ...
       const formData = new FormData();
        ...
        this.ModifierAccueil(formData, config);
             this.$router.push({
                  name:"AfficheAccueil",
              })
        },
