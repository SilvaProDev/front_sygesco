<template>
  <div>
       <div>
          <h1 class="text-center">Paiement de la scolarité</h1> 
       </div> 
                  ...
                  <table class="table align-items-center table-flush" id="dataTable">
                    ...
                    <tbody>
                      ...
                      <tr v-for="(item, index) in localisationsFiltre" :key="item.id" :value="item.id">
                        ...
                        <td> 
                          <a class="btn btn-warning" href="" @click.prevent="Modification(item.id)">
                            Payer
                          </a> 
                            &nbsp;
    ...
    <div   class="overlay">
      <div class="modale card" >
          <button class="close" @click="fermer">x</button>
           ...
           <h5 style="color:red;">Paiement de la scolarité</h5>
             ...
             <form action="" method="post">
              ...
              <div class="form-group">
                  <label for="libelle">Reste à payer </label>   
                     <!-- <money :value="ResteaPayer"  readOnly  style="text-align:left;color:red;font-size:16px"  class="form-control"></money> -->
                  <input disabled  :value=" formatageSomme(parseFloat(ResteaPayer))"  class="form-control" id="libelle" aria-describedby="emailHelp"
              ...
              <div class="form-group">
                  ...
                  <input v-model="formData.date" @input="$v.formData.date.$touch()" type="datetime-local"  class="form-control" id="scolarite" aria-describedby="emailHelp"
                  placeholder="Entrer le scolarite">
              </div>
