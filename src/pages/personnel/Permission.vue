            ...
            <div class="col-lg-11 mb-4">
              <div class="card">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">La liste des Permissions</h6>
                </div>
                <div class="table-responsive">
                  <table class="table align-items-center table-flush">
                    ...
                    <tbody>
                      <tr v-for="(item, index) in gettersPermission" :key="item.id">
                        <td>{{index+1}}</td>
                        <td>{{item.code}}</td>
                        <td>{{item.libelle}}</td>
                        ...
                        <td>
                           <button  @click="editModale(item.id)" title="Modifier" type="button"  data-toggle="modal" data-target="#exampleModalCenter">
                              ...
                              &nbsp;
                          <a title="Supprimer"  @click.prevent="SupprimerPermission(item.id)">
  ...
  <div class="bloc-modale" v-if="showModal">
    <div   class="overlay">
      <div class="modale card" >
           ...
           <h4>Enrégistrement de la permission </h4>
  ...
  <div class="bloc-modale" v-if="showIsModal">
    <div   class="overlay">
      <div class="modale card" >
           ...
           <h4>Modification de la permission </h4>
  ...
  methods:{
    ...
    //vider les champs
      ...
      editModale(id){
        ...
        this.editText = this.gettersPermission.find(tem =>tem.id == id)
      },
    ...
    AjouterFonctionLocal(){
        ...
        this.AjouterPermission(this.formData)
            this.$v.formData.$reset();
         this.formData.code="";
