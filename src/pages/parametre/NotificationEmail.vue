<template>
  <div>
    <Entete/>
       <div>
          <h1 class="ml-5">Envoi d'email au parents</h1> 
       </div> 
      <div class="d-sm-flex align-items-center justify-content-between mb-2 ml-5">
        ...
        <p v-if="formData.classe_id == '' && formData.niveau_id == ''" class=" ml-5 text-gray-800 font-weight-bold"> Selectionnez  le niveau et la classe pour envoyer le message </p>
          ...
          <div class="row" >
            ...
            <div class="col-lg-12" v-if="formData.classe_id  && formData.niveau_id && EmailDesParents.length !=0">
              <!-- General Element -->
              <div class="card mb-4 m-3">
                ...
                <div class="card-body">
                  <form>
                    <div class="form-group">
                      <label for="date">Date d'envoi d'email</label>
                    ...
                    <div class="form-group">
                      <label for="exampleFormControlInput1">Email Parent</label>
                     <textarea disabled :value="EmailDesParents" class="form-control" id="exampleFormControlInput1" rows="1"></textarea>
                    </div>
                    <div class="form-group">
                      <label for="exampleFormControlInput2">Sujet</label>
                       <span style="color:red; font-style:italic;"
                          v-if="$v.formData.sujet.$error && !$v.formData.sujet.required"
                          role="alert"> 
                          <span style="color:red; font-weight:bold">*</span>
                          Ce champs est obligatoire!
                      </span>
                    <input v-model="formData.sujet" type="text" class="form-control" id="exampleFormControlInput2">
                    </div>
...
export default {
  ...
  methods:{
     ...mapActions("parametres",["getNiveau","AjouterNiveau", "ModifierNiveau","SupprimerNiveau","getClasse",
                   "getTrimestre","getMatiere", "getAnnee", "AjouterMessageEmail"]),
      ...
      Modification(id){
       ...
       fermer(){
        ...
        AjouterFonctionLocal(){
         ...
         //   EmailParent: this.EmailDesParents
